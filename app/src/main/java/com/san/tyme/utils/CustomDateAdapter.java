    ...
    */
    ...
    static class CustomDateViewHolder extends AbsDateItemHolder {
        ...
        public void setMonthName(Date date) {
            tvMonth.setText(PagerDatePickerDateFormat.DATE_PICKER_MONTH_NAME_FORMAT.format(date).substring(0,3));
        }

        @Override
        public void setDayName(Date date) {
            tvDayName.setText(PagerDatePickerDateFormat.DATE_PICKER_DAY_NAME_FORMAT.format(date).substring(0,3));
        }
